...
This project was the first of two introducing networking concepts. In this project, I answered a few quiz-like questions and wrote a couple bash scripts while learning about the OSI model, LAN and WAN networks, TCP/UDP data transfer protocols
BY ALX (Holberton) -Software Engineering
Solved By ANASS EL HAMDI ALAOUI
